...
func TestObjectRead(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			ctx,
			application.FirstKindVersion(),
			object.ByName(testutil.RandomName()),
			nil,
			"invalid selector: domain required",
		},
		{
		...
		},
		{
			...
			ctx,
			application.FirstKindVersion(),
			object.ByDomainAndUUID(dom, svc1.UUID()),
			nil,
			"not found",
		},
		/*
			{
				...
				selector.New(
					...
					selector.WithNamespace(svc1.Namespace()),
					selector.WithUUID(svc1.UUID()),
		...
		*/
		{
			...
			ctx,
			application.FirstKindVersion(),
			object.ByDomainAndUUID(dom, app1.UUID()),
			app1,
			"",
		},
		{
			...
			ctx,
			application.FirstKindVersion(),
			object.ByDomainAndName(dom, app1.Name()),
			app1,
			"",
		},
		{
			...
			ctx,
			service.FirstKindVersion(),
			object.ByNamespaceAndUUID(ns, svc1.UUID()),
			svc1,
			"",
		},
		{
			...
			ctx,
			service.FirstKindVersion(),
			object.ByNamespaceAndName(ns, svc1.Name()),
			svc1,
			"",
		},
	}
